...
// let's get my preferred font
std::shared_ptr<Font> font = APP->window->loadFont(asset::plugin(pluginInstance, "res/tahomabd.ttf"));
...
Label* addLabel(const Vec& v, const char* str, const int fSize=10, const NVGcolor& color = nvgRGBA(0, 0, 0, 255))
{
